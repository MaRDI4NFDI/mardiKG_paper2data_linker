...
async def get_dataset_metadata_as_md(dataset_id: int) -> str:
...
def get_citations_from_metadata_md(metadata_md):
    ...
    """
    return extract_citations(metadata_md)


def get_url_from_metadata_md(text):
...
def get_name_from_metadata_md(text):
...
def get_dataset_intro_paper(dataset_id: int):
